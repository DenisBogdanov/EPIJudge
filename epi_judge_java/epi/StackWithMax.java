...
public class StackWithMax {
    ...
    public static class Stack {
        private final Deque<ValueToCurrMaxPair> stack = new ArrayDeque<>();
        ...
        public void push(Integer x) {
            if (empty()) {
                stack.push(new ValueToCurrMaxPair(x, x));
            } else {
                stack.push(new ValueToCurrMaxPair(x, Math.max(stack.peek().currMax, x)));
            }
        }

        private static class ValueToCurrMaxPair {
            final int value;
            final int currMax;

            public ValueToCurrMaxPair(int value, int currMax) {
                this.value = value;
