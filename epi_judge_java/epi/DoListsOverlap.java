...
public class DoListsOverlap {
    ...
    public static ListNode<Integer> overlappingLists(ListNode<Integer> list1, ListNode<Integer> list2) {
        ...
        ListNode<Integer> cycleStart1 = IsListCyclic.hasCycle(list1);
        ListNode<Integer> cycleStart2 = IsListCyclic.hasCycle(list2);

        if (cycleStart1 != null && cycleStart2 != null) {
            ListNode<Integer> runner2 = cycleStart2;
            do {
                if (runner2 == cycleStart1) return runner2;
                runner2 = runner2.next;
            } while (runner2 != cycleStart2);

            return null;
        } else if (cycleStart1 == null && cycleStart2 == null) {
